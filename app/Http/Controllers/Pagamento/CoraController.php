...
class CoraController extends Controller
{
    ...
    public static function pagamentos(Request $request)
    {
        $uuid = Uuid::uuid4();
    ...
    public function cancelarBoleto(Request $request, $codigo_pagamento)
    {
        $uuid = Uuid::uuid4();
        ...
        try {
            $url = "https://api.stage.cora.com.br/payments/initiate/$codigo_pagamento";
